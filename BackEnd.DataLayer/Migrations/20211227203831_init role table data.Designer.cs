...
namespace BackEnd.DataLayer.Migrations
{
    ...
    [Migration("20211227203831_init role table data")]
    partial class initroletabledata
    {
            ...
            modelBuilder.Entity("BackEnd.DataLayer.Entities.Access.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2021, 12, 28, 0, 8, 30, 432, DateTimeKind.Local).AddTicks(3148),
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 12, 28, 0, 8, 30, 436, DateTimeKind.Local).AddTicks(694),
                            Name = "Admin",
                            Title = "ادمین سایت"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2021, 12, 28, 0, 8, 30, 436, DateTimeKind.Local).AddTicks(3635),
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 12, 28, 0, 8, 30, 436, DateTimeKind.Local).AddTicks(3671),
                            Name = "SuperAdmin",
                            Title = "ادمین سایت"
                        });
                });
